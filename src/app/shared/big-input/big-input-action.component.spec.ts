...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<super-memory-big-input-action></super-memory-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<super-memory-big-input-action [disabled]="true"></super-memory-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<super-memory-big-input-action fontSet="fas" fontIcon="fa-trash"></super-memory-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<super-memory-big-input-action label="delete"></super-memory-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<super-memory-big-input-action (action)="actionHandler()"></super-memory-big-input-action>`;
    fixture = createHostComponent(template);
